...
// ==/UserScript==
"use strict";
/* The compiler injects every validated lesson document into this slot.
...
(function () {
  ...
  var STRINGS = {
    en: { panel: "Malgwi", vocab: "Vocabulary", pron: "Pronunciation", trans: "Translation",
          ...
          jump: "Jump to this segment", repeat: "Repeat: once \u2192 loop \u2192 off", sentence: "Sentence repeat", speed: "Playback speed", opacity: "Panel opacity", resize: "Resize", off: "Turn Malgwi off", offToast: "Malgwi is off \u2014 press Alt+M (\u2325M) to bring it back.", add: "+ Vocab: ",
    ...
    ko: { panel: "말귀", vocab: "단어장", pron: "발음", trans: "번역",
          ...
          jump: "이 구간으로 이동", repeat: "반복: 1회 \u2192 계속 \u2192 해제", sentence: "문장 반복", speed: "재생 속도", opacity: "패널 투명도", resize: "크기 조절", off: "말귀 끄기", offToast: "말귀를 껐습니다 \u2014 Alt+M (\u2325M)으로 다시 켤 수 있습니다.", add: "+ 단어장: ",
    ...
    zh: { panel: "Malgwi", vocab: "生词本", pron: "发音", trans: "翻译",
          ...
          jump: "跳转到此片段", repeat: "循环: 一次 \u2192 持续 \u2192 关闭", sentence: "整句循环", speed: "播放速度", opacity: "面板透明度", resize: "调整大小", off: "关闭 Malgwi", offToast: "Malgwi 已关闭 \u2014 按 Alt+M (\u2325M) 重新打开。", add: "+ 生词: ",
    ...
    ja: { panel: "Malgwi", vocab: "単語帳", pron: "発音", trans: "翻訳",
          ...
          jump: "この区間へ移動", repeat: "リピート: 1回 \u2192 連続 \u2192 解除", sentence: "文リピート", speed: "再生速度", opacity: "パネルの不透明度", resize: "サイズ変更", off: "Malgwi をオフ", offToast: "Malgwi をオフにしました \u2014 Alt+M (\u2325M) で再表示できます。", add: "+ 単語帳: ",
